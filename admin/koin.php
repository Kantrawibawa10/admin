...
<section class="page-content">
  <section class="search-and-user">
    ...
    <section class="grid KANAN">
      <section class="koinheader">
         <div class="koin dashboardkoin">
    ...
    <section class="userfollow">
       <div class="margin">
         ...
         <div class="follower">
           <div class="user">
             <img src="assets/img/user.jpg" alt="" class="profile-img">
             <p class="nama-user">Andi Budi Susanto</p>
           </div>
         ...
         <div class="follower">
           <div class="user">
             <img src="assets/img/user.jpg" alt="" class="profile-img">
             <p class="nama-user">Candra Budi Setiawan</p>
           </div>
