  ...
  <section class="search-and-user">
    ...
    <section class="grid KANAN">
      ...
      <section class="profile">
         <div class="username dashboardprofile">
            <div class="border-bg" style="display: flex; padding: 50px; background: #fff; border: 1px solid #707070;
              width: 100%;
              height: 30vh;
              padding: 55px;
              border-radius: 30px;">
              <img src="assets/img/user.jpg" class="userprofile" alt="">
    ...
    <section class="detail-user">
       <div class="margin-user">
         <div class="desc">
            <h1>Kode Reveral</h1> <span style="margin-left: 60px;">: A001</span>
         </div>
         <div class="desc">
            <h1>Nama</h1> <span style="margin-left: 127px;">: Setya Novanto</span>
         </div>
         <div class="desc">
            <h1>Username</h1> <span style="margin-left: 89px;">: Novanto</span>
         </div>
         <div class="desc">
            <h1>Email</h1> <span style="margin-left: 131px;">: novanto@gmail.com</span>
         </div>
         <div class="desc">
            <h1>Gender</h1> <span style="margin-left: 114.5px;">: Laki - laki</span>
         </div><div class="desc">
            <h1>Alamat</h1> <span style="margin-left: 116.5px;">: Jl.Diponogoro No.27 Denpasar Utara</span>
         </div>
         <div class="desc">
            <h1>Status</h1> <span style="margin-left: 125px;">: Member</span>
         </div>
