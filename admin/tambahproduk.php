...
<header class="page-header">
  <nav>
      <a href="#0" aria-label="forecastr logo" class="logo">
          <img src="assets/img/logo.png" alt="BOOMBEST">
          <h2 style="font-size: 20px; margin-top: 10px; margin-left: -10px;">BOOMBEST</h2>
      </a>
    ...
    <section class="tambah">
       <div class="margin">
         ...
         <form class="form-tambah" method="post" enctype="multipart/form-data">
           <div class="tambah-produk-keterangan1">
               <!--img upload--->
               <p class="image_upload">
                   <label class="img-upload">
                       ...
                       <img src="assets/img/tambahimg.png" alt="" class="foto-upload bg-img">
                       <label class="btn-input">
                           <input type="file" name="img_barang" required>
               ...
               <div class="margin-form">
                 ...
                 <div class="form-input">
                   <p class="title-desc">Kode Barang: </p>
                   <input type="text" class="form-control-lg" name="kode" value="" required>
                 </div>
                 <!--form input -->

                 <!--form input -->
                 <div class="form-input">
                   <p class="title-desc">Nama Barang: </p>
                   <input type="text" class="form-control-lg" name="nama_barang" value="" required>
                 </div>
                 <!--form input -->

                 <!--form input -->
                 <div class="form-input">
                   <p class="title-desc">Harga: </p>
                   <input type="text" class="form-control-md" name="harga" value="" placeholder="Rp:..." required>
                 </div>
                 <!--form input -->

                 <!--form input -->
                 <div class="form-input">
                   <p class="title-desc">Stok: </p>
                   <input type="number" class="form-control-sm" name="stok" value="" required>
                 </div>
                 <!--form input -->
               </div>
           </div>
             ...
             <h1>Detail Produk</h1>
              ...
              <div class="tambah-produk-keterangan1">
               <div class="margin-form">
                 <!--form input -->
                 <div class="form-input">
                   <p class="title-desc">Kondisi: </p>
                   <input type="text" class="form-control-md1" name="kondisi" value="" required>
                 </div>
                 <!--form input -->

                 <!--form input -->
                 <div class="form-input">
                   <p class="title-desc">Berat: </p>
                   <input type="text" class="form-control-md1" name="berat" value="" required>
                 </div>
                 <!--form input -->

                 <!--form input -->
                 <div class="form-input">
                   <p class="title-desc">Kategori: </p>
                   <input type="text" class="form-control-md1" name="kategori" value="" required>
                 </div>
                 <!--form input -->

                 <!--form input -->
                 <div class="form-input-desc">
                   <p class="title-desc">Spesifikasi: </p>
                   <textarea name="spesifikasi" rows="8" cols="80" required></textarea>
                 </div>
                 <!--form input -->

                 <!--form input -->
                 <div class="form-input-desc">
                   <p class="title-desc">Keunggulan: </p>
                   <textarea name="keunggulan" rows="8" cols="80" required></textarea>
                 </div>
                 <!--form input -->

                 <!--form input -->
                 <div class="form-input-desc">
                   <p class="title-desc">Ketentuan<br> Garansi: </p>
                   <textarea name="garansi" rows="8" cols="80" required></textarea>
                 </div>
                 <!--form input -->

                 <!--form input -->
                 <div class="form-input-desc">
                   <p class="title-desc">Deskripsi<br> lainnya: </p>
                   <textarea name="lainnya" rows="8" cols="80" required></textarea>
                 </div>
                 <!--form input -->
               </div>
           </div>
           ...
           <hr class="batas">
            ...
            .tambah .margin .btn button:hover{
...
<?php
    ...
    if(isset($_POST['tambah'])){
        $nama = $_FILES['img_barang']['name'];
        $lokasi = $_FILES['img_barang']['tmp_name'];
        move_uploaded_file($lokasi,"assets/img/products/".$nama);



          $sql = mysqli_query($koneksi,"INSERT INTO barang(kode,img_barang,nama_barang,harga,stok,kondisi,berat,kategori,spesifikasi,keunggulan,garansi,lainnya)
          VALUES('$_POST[kode]','$nama','$_POST[nama_barang]','$_POST[harga]','$_POST[stok]','$_POST[kondisi]','$_POST[berat]','$_POST[kategori]','$_POST[spesifikasi]','$_POST[keunggulan]','$_POST[garansi]','$_POST[lainnya]')") or die(mysqli_error($koneksi));

          if($sql){
            echo '<script>alert("Berhasil menambahkan product."); document.location="index.php";</script>';
          }else{
            echo '<div class="alert alert-warning">Gagal melakukan proses tambah produk.</div>';
          }
          }else{
            echo '<div class="alert alert-warning">Gagal, Produk sudah terdaftar.</div>';
        }
